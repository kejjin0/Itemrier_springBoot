...
<body>
	<form action="/usedGoods/create" method="POST" enctype="multipart/form-data">
		<table>
                <tr>
                    <td>제목(상품명)</td>
                    <td><input type="text" name="itemName" placeholder="등록할 제목을 입력하세요"></td>
                </tr>
                <tr>
                    <td>상품 정보</td>
                    <td><input type="text" name="description" placeholder="상품 정보를 입력해주세요"></td>
                </tr>
                <tr>
                    <td>제품 상태</td>
                    <td>
                ...
                <tr>
                    <td>등록 가격</td>
                    <td>
                        <input type="number" name="price" placeholder="등록 가격을 입력하세요" min="0">
                        <span>원</span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>연락 수단</td>
                    <td><input type="text" name="contactType" placeholder="카카오톡 아이디, 전화번호 등 연락할 수단을 입력해주세요"></td>
                </tr>
                <tr>
                    <td>상품 사진</td>
